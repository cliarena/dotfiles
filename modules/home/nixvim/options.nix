{ ... }: {
  ...
  hlsearch = false; # # keeps search patterns highlighted after search
  ...
  undodir = "$XDG_CONFIG_HOME/undo_dir";
  ...
  spell = true;
  spelllang = "en";
  scrolloff = 8; # # show 8 lines after cursor
  sidescrolloff = 8; # # show 8 charachters after cursor
}

...
in {
  ...
  config = mkIf config.${module}.enable {
    ...
    programs.nixvim.globals.editorconfig = false;
    programs.nixvim.globals.loaded_man = false;
    programs.nixvim.globals.loaded_matchit = 1;
    programs.nixvim.globals.loaded_matchparen = 1;
    programs.nixvim.globals.loaded_remote_plugins = 1;
    programs.nixvim.globals.loaded_shada_plugin = 1;
    programs.nixvim.globals.loaded_spellfile_plugin = 1;
    programs.nixvim.globals.loaded_gzip = 1;
    programs.nixvim.globals.loaded_tar = 1;
    programs.nixvim.globals.loaded_tarPlugin = 1;
    programs.nixvim.globals.loaded_zip = 1;
    programs.nixvim.globals.loaded_zipPlugin = 1;
    programs.nixvim.globals.loaded_2html_plugin = 1;
    programs.nixvim.globals.loaded_tutor_mode_plugin = 1;
    programs.nixvim.globals.loaded_python3_provider = 0;
    programs.nixvim.globals.loaded_ruby_provider = 0;
    programs.nixvim.globals.loaded_perl_provider = 0;
    programs.nixvim.globals.loaded_node_provider = 0;

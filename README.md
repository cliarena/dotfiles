...
# Testing docker image
 ...
 - `sudo podman run --name=desk  -d --privileged --ipc=host -e XDG_RUNTIME_DIR=/run/user/1000 -v /run/user/1000:/run/user/1000:rw -e WAYLAND_DISPLAY=wayland-1 nixos /init`
 - `sudo podman exec -it desk /run/current-system/sw/bin/bash`

...
in
{
  ...
  config = mkIf config.${module}.enable {
    ...
    virtualisation.oci-containers.containers.wolf = {
      ...
      ports = [
        "0.0.0.0:47984:47984/tcp"
        "0.0.0.0:47989:47989/tcp"
        "0.0.0.0:47999:47999/udp"
        "0.0.0.0:48010:48010/tcp"

        # Video port for each user
        "0.0.0.0:48100-48103:48100-48103/udp"

        # Audio port for each user
        "0.0.0.0:48200-48203:48200-48203/udp"
      ];
